...
<html>
    <body>
        <?php
            ...
            echo '<p><a href="http://webinfo/~maurinn/PHP/TD7/index.php?action=delete&immat='.$vImmat.'">SUPPRIMER CETTE VOITURE</a>.</p>';

            echo '<p><a href="http://webinfo/~maurinn/PHP/TD7/index.php?action=update&immat='.$vImmat.'">MODIFIER CETTE VOITURE</a>.</p>';
        ?>
    </body>
</html>